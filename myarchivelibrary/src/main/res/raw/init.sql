...
CREATE TABLE IF NOT EXISTS magazines_tags(
    id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
    magazines INTEGER NOT NULL,
    tags INTEGER NOT NULL,
    timestamp TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY(magazines) REFERENCES magazines(id) ON DELETE CASCADE ON UPDATE CASCADE,
    FOREIGN KEY(tags) REFERENCES tags(id) ON DELETE CASCADE ON UPDATE CASCADE
);

CREATE TABLE IF NOT EXISTS magazines_persons(
    id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
    magazines INTEGER NOT NULL,
    persons INTEGER NOT NULL,
    timestamp TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS magazines_companies(
    id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
    magazines INTEGER NOT NULL,
    companies INTEGER NOT NULL,
    timestamp TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTSgames_persons(
    id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
    games INTEGER NOT NULL,
    persons INTEGER NOT NULL,
    timestamp TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
