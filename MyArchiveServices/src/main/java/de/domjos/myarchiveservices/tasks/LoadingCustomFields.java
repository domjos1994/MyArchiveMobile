...
public class LoadingCustomFields extends CustomExtendedStatusTask<Void, CustomField> {

    private final WeakReference<SwipeRefreshDeleteList> lv;
    private final Database database;
    private final String searchString;

    public LoadingCustomFields(Activity activity, SwipeRefreshDeleteList lv, String searchString, boolean notification, int icon_notification, Database database) {
    ...
    @Override
    protected List<CustomField> doInBackground(Void voids) {
        try {
