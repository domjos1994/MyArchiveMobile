    ...
    public Fragment getItem(int position) {
        ...
        switch (position) {
            ...
            case 3:
                fragment = this.fragmentManager.findFragmentByTag(this.getFragmentTag(position));
                if(fragment!=null) {
                    if(fragment instanceof MediaMovieFragment) {
                        this.mediaMovieFragment = (MediaMovieFragment) fragment;
                        this.fragmentManager.beginTransaction().detach(this.mediaMovieFragment).attach(this.mediaMovieFragment).commit();
                    }
                }
