...
public class MainMoviesFragment extends ParentFragment {
    ...
    private void initControls(View view) {
        ...
        this.moviePagerAdapter = new MoviePagerAdapter(this.requireActivity(), this.getContext(),() -> currentObject = ControlsHelper.loadItem(this.getActivity(), this, moviePagerAdapter, currentObject, lvMovies, new Movie()));
